...
public class CourseGUI {
    ...
    private void saveCourse() {
        ...
        // FIXED: Using course_description instead of course_code
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            pstmt.setString(2, code); // Saving the code from the GUI into the description column
    ...
    private void updateCourse() {
        ...
        // FIXED: Using course_description
    ...
    private void deleteCourse() {
        ...
        if (JOptionPane.showConfirmDialog(CoursePanel, "Delete this course?", "Confirm", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
            try (Connection conn = DatabaseConnection.getConnection();
                 // FIXED: Primary key is course_id
    ...
    private void loadCourseData() {
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                // FIXED: Matched exact DB columns
